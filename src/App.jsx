...
const subjects = {
  ...
  {id:71,category:"Lochner Era",type:"multiple_choice",question:"Williamson v. Lee Optical (1955) is the paradigmatic case for:",options:["Extreme deference under rational basis review, asking only what the legislature 'might have' concluded","Heightened scrutiny of professional licensing schemes that restrict entry into a trade","Strict scrutiny of laws affecting fundamental rights to occupation","Procedural due process review of administrative rulemaking"],answer:0,explanation:"Lee Optical exemplifies post-Lochner deference: the Court asks only whether the legislature 'might have' had a rational basis. The Court has not struck down economic legislation under substantive due process since 1936."},
  ...
  {id:73,category:"Standards of Review",type:"multiple_choice",question:"Korematsu v. United States (1944) is significant in equal protection doctrine because, despite upholding the internment order, it:",options:["Established that 'most rigid scrutiny' applies to racial classifications, planting the seed for modern strict scrutiny","First articulated the rational basis test for racial classifications during wartime","Held that the Fifth Amendment's Due Process Clause does not contain an equal protection component","Created a categorical exception to constitutional review for military necessity"],answer:0,explanation:"Korematsu announced that racial classifications demand 'the most rigid scrutiny' — language that became the strict scrutiny standard. Modern doctrine treats race-based classifications as virtually per se unconstitutional, even though Korematsu itself upheld the order."},
  ...
  {id:78,category:"Equal Protection",type:"multiple_choice",question:"Washington v. Davis (1976) holds that, under the Equal Protection Clause:",options:["A racially disparate impact alone is sufficient to invalidate a facially neutral law","All employment tests must be validated as job-related under a strict scrutiny standard","Racially disparate impact, without discriminatory purpose, does not establish a constitutional violation","Statistical proof of discrimination shifts the burden to the government to show a compelling interest"],answer:2,explanation:"Washington v. Davis requires discriminatory intent for an EPC violation; disparate impact alone is insufficient. This anti-classification approach is in tension with anti-subordination theory and remains a major constraint on EPC claims today."},
  {id:79,category:"Equal Protection",type:"multiple_choice",question:"Personnel Administrator of Massachusetts v. Feeney (1979) clarified that 'discriminatory intent' under the Equal Protection Clause means:",options:["The decisionmaker was aware that a foreseeable consequence of the law would burden women","A pattern of disparate impact, which is presumed evidence of intent absent rebuttal","Any subjective bias by an individual official, even absent legislative intent","The law was chosen 'because of,' not merely 'in spite of,' its adverse effects on a protected group"],answer:3,explanation:"Feeney heightened Washington v. Davis: intent requires more than volition and awareness of consequences. The legislature must have chosen the law 'because of' its adverse effects on the protected group, not merely 'in spite of' them."},
  ...
  {id:81,category:"Standards of Review",type:"multiple_choice",question:"Craig v. Boren (1976) is significant because it:",options:["Applied strict scrutiny to a sex-based classification for the first time","Established that men cannot bring equal protection claims because they are not a suspect class","Held that all sex-based classifications must be analyzed under rational basis review","Created the intermediate scrutiny standard for sex-based classifications: substantially related to an important government interest"],answer:3,explanation:"Craig v. Boren created intermediate scrutiny. The 'near beer' law (banning sale to men under 21 but allowing sale to women under 21) failed because maleness was not a sufficiently good proxy for the state's traffic-safety interest."},
  ...
  {id:85,category:"Affirmative Action",type:"multiple_choice",question:"Grutter v. Bollinger (2003) upheld Michigan Law School's race-conscious admissions because:",options:["The school used a points system that gave a fixed numerical bonus for race","Strict scrutiny does not apply to admissions decisions at public universities","Diversity is a remedial interest tied to specific past discrimination by the school","Race was used as one factor in a holistic, individualized review aimed at achieving a 'critical mass'"],answer:3,explanation:"Grutter applied strict scrutiny but deferred to the school's diversity interest. The narrow tailoring required holistic, individualized review with race as one factor — no quotas, but pursuit of a 'critical mass' was permissible. The companion case Gratz struck down Michigan's undergraduate point system as too quota-like."},
  ...
  {id:92,category:"Right to Die",type:"multiple_choice",question:"In Cruzan v. Director (1990), the Court held that a state may:",options:["Categorically prohibit the withdrawal of nutrition from any incompetent patient","Authorize physician-assisted suicide for terminally ill patients","Require 'clear and convincing evidence' of an incompetent patient's wish to refuse life-sustaining treatment","Defer entirely to family members' decisions about end-of-life care"],answer:2,explanation:"Cruzan assumed (without holding) that competent persons have a right to refuse treatment, but allowed states to require clear and convincing evidence of an incompetent patient's prior wishes — putting a thumb on the scale toward preserving life."},
  ...
  {id:95,category:"Sexual Orientation",type:"multiple_choice",question:"Romer v. Evans (1996) struck down Colorado's Amendment 2 because the Court found:",options:["Sexual orientation is a suspect classification triggering strict scrutiny","Colorado lacked authority to amend its constitution on civil rights matters preempted by federal law","The amendment violated the Privileges and Immunities Clause of Article IV","The amendment served no purpose other than animus toward a politically unpopular group, failing even rational basis review"],answer:3,explanation:"Romer applied 'RBR with bite' (echoing Moreno and Cleburne): a bare desire to harm a politically unpopular group is not a legitimate state interest. The Court did not declare sexual orientation a suspect class."},
  ...
  {id:99,category:"Removal Power",type:"multiple_choice",question:"Seila Law v. CFPB (2020) held that:",options:["The CFPB's structure was constitutional under Humphrey's Executor's protections for independent agencies","Article II's Vesting Clause is purely ceremonial and imposes no limits on agency design","The President has no removal power over heads of independent agencies created by Congress","It violates separation of powers for an executive agency to be headed by a single director removable by the President only for cause"],answer:3,explanation:"Seila Law cabined Humphrey's Executor to its facts (multimember bodies with quasi-legislative/judicial functions) and reflects the rise of Unitary Executive Theory. Kagan's dissent argued the majority overweighted the Vesting Clause and ignored historical practice."},
  {id:100,category:"Executive Power",type:"multiple_choice",question:"Trump v. United States (2024) established that a former President has:",options:["No immunity from criminal prosecution for any conduct during the presidency","Immunity only for acts authorized by Congress under the Take Care Clause","Absolute immunity for all conduct, official or unofficial, occurring during the presidency","Absolute immunity for official acts within the President's exclusive constitutional authority, presumptive immunity for other official acts, and no immunity for unofficial acts"],answer:3,explanation:"Trump created a three-tier framework and forbade juries from considering official acts as evidence of unofficial conduct. Roberts borrowed Jackson's Youngstown analysis: 'preclusive and conclusive' presidential power gets absolute immunity; the outer perimeter gets presumptive immunity."},
  ...
  {id:104,category:"14th Amendment Enforcement",type:"multiple_choice",question:"In City of Boerne v. Flores (1997), the Court struck down RFRA as applied to states because:",options:["Congress lacks any power to enforce the First Amendment against the states","The statute violated the Establishment Clause by giving special treatment to religion","The Free Exercise Clause is not incorporated against the states","RFRA exceeded Congress's Section 5 power by attempting to define the substance of constitutional rights, rather than enforcing them through 'congruent and proportional' means"],answer:3,explanation:"Boerne created the 'congruence and proportionality' test for Section 5 legislation. Congress can remediate and prevent constitutional violations, but cannot redefine the substance of rights — that is the Court's role under Marbury. The case vindicates Harlan's dissent in Katzenbach v. Morgan."}
    ]
  },
  "Property Law": {
    emoji: "🏠",
  ...
  // === EXPANDED COVERAGE: SELF-HELP, NUISANCE REMEDIES, FAIR HOUSING, RECORDING, LEASES, EASEMENTS, COVENANTS, ZONING, TAKINGS ===
  {id:54,category:"Protection of Property",type:"true_false",question:"Under Berg v. Wiley and the modern majority rule, a commercial landlord may use peaceful self-help (such as changing the locks) to retake possession when the tenant violates the lease.",answer:1,explanation:"False. Berg v. Wiley adopted the modern rule that landlords must use the judicial process — self-help is not permitted, even when peaceful and even when the lease contains a reentry clause."},
  {id:55,category:"Protection of Property",type:"multiple_choice",question:"In Berg v. Wiley (1978), the court held that a commercial landlord who locks out a defaulting tenant:",options:["Must use the judicial process — peaceful self-help is no longer permitted", "May change locks if the lease has a reentry clause and entry is peaceful", "May use any reasonable force short of physical injury to retake the premises", "Has unlimited self-help rights against commercial (non-residential) tenants"],answer:0,explanation:"Berg v. Wiley rejected the common-law rule allowing peaceful self-help reentry. Modern law requires judicial process — even when the lease has a reentry clause and even in commercial settings."},
  {id:56,category:"Protection of Property",type:"multiple_choice",question:"Under UCC Article 9 and Williams v. Ford Motor Credit (1982), a secured party repossessing collateral may proceed without judicial process so long as:",options:["The repossession occurs during business hours and notice is provided in advance", "There is no breach of the peace — defined as force, threats of force, or risk of inviting violence", "The debtor is given a 30-day right to cure under state law", "The collateral is parked on public property at the time of repossession"],answer:1,explanation:"UCC § 9-609 permits self-help repossession only if accomplished without 'breach of the peace.' Williams reads this narrowly — silence in the face of repossession is not objection, even where the debtor was awakened in the middle of the night."},
  {id:57,category:"Protection of Property",type:"multiple_choice",question:"In People v. Olivo (1981), the modern actus reus for shoplifting larceny is satisfied when:",options:["The shoplifter physically exits the store with the merchandise concealed", "A store employee personally observes the concealment of merchandise inside the store", "The shoplifter exercises dominion and control over the merchandise in a manner inconsistent with the store's continued rights", "The shoplifter has placed merchandise in their personal bag, regardless of intent"],answer:2,explanation:"Olivo modernized larceny: the historical 'trespassory taking' is replaced by exercise of dominion and control inconsistent with the owner's rights. Movement out of the store is evidence of intent but not strictly required."},
  {id:58,category:"Trespass & Nuisance",type:"true_false",question:"In Intel Corp. v. Hamidi (2003), the California Supreme Court held that mass unsolicited emails constituted trespass to chattels even without proof of physical damage to Intel's computer systems.",answer:1,explanation:"False. Hamidi held that trespass to chattels requires actual injury to the property — lost employee time and productivity were insufficient. Without measurable harm to the computers, Intel had no trespass claim."},
  {id:59,category:"Trespass & Nuisance",type:"multiple_choice",question:"In Adams v. Cleveland Cliffs (1999), the court held that intangible intrusions like noise, vibrations, and dust:",options:["Constitute trespass per se because they cross the property boundary", "May give rise to a trespass action when they exceed background ambient levels", "Are governed by federal environmental statutes that preempt state property law", "Do not give rise to an action in trespass — possessors must instead sue under nuisance"],answer:3,explanation:"Adams preserved the trespass/nuisance distinction by requiring a tangible, physical intrusion for trespass. Intangible invasions like noise and dust must be litigated as nuisances, which require actual and substantial injury."},
  {id:60,category:"Trespass & Nuisance",type:"multiple_choice",question:"In Campbell v. Seaman (1876), the court issued an injunction against the brickyard rather than awarding damages because:",options:["The harm was irreparable, difficult to assess, and damages alone would produce a multiplicity of suits", "Brickburning was found to be a public nuisance per se under state common law", "The plaintiff had been first in time to occupy the area as residential property", "The defendant had no reciprocal benefit from the plaintiff's use of his land"],answer:0,explanation:"Campbell illustrates the traditional grounds for an equitable injunction in nuisance: irreparable harm, difficulty calculating damages, and avoiding repeated suits. The court did not balance utility against harm — once a nuisance was established, the injunction followed."},
  {id:61,category:"Trespass & Nuisance",type:"multiple_choice",question:"Boomer v. Atlantic Cement (1970) is associated with which Calabresi-Melamed remedial regime?",options:["Property rule protecting the defendant — cement plant continues operating with no payment", "Property rule protecting the plaintiff — cement plant must shut down absent the plaintiff's consent", "Liability rule protecting the defendant — plaintiffs must pay cement plant to stop polluting", "Liability rule protecting the plaintiff — cement plant continues operating but must pay damages"],answer:3,explanation:"Boomer is the canonical Rule 4 case: although plaintiffs prevailed on nuisance, the court refused to enjoin the multimillion-dollar cement plant, instead awarding permanent damages. This is a forced sale of the entitlement at a court-determined price."},
  {id:62,category:"Trespass & Nuisance",type:"multiple_choice",question:"In Spur Industries v. Del Webb Development (1972), the court held that the cattle feedlot:",options:["Could not be enjoined because the residential developer had 'come to the nuisance'", "Must move, but the residential developer must indemnify the feedlot for the cost of relocation", "Could continue operating because public benefit from cattle production outweighed the residents' harm", "Was a public nuisance with no civil remedy available to private parties"],answer:1,explanation:"Spur is the Calabresi-Melamed Rule 4 inverse: the court enjoined the feedlot (protecting residents) but required the developer who 'came to the nuisance' to pay the feedlot for relocation. Both parties bore part of the cost."},
  {id:63,category:"Trespass & Nuisance",type:"multiple_choice",question:"The Coase Theorem holds that, in the absence of transaction costs:",options:["Government regulation is always more efficient than private bargaining for resolving externalities", "Initial allocation of property rights determines the most efficient ultimate use of resources", "The initial allocation of property rights does not affect the efficient outcome — parties will bargain to it regardless", "Liability rules are categorically superior to property rules for high-stakes disputes"],answer:2,explanation:"Coase argued that with well-defined rights and zero transaction costs, parties will bargain to the efficient outcome regardless of initial allocation. In the real world, transaction costs matter — which is why courts must choose property vs. liability rules carefully."},
  {id:64,category:"Trespass & Nuisance",type:"true_false",question:"Under Calabresi and Melamed's framework, a 'liability rule' lets the holder of an entitlement choose whether to sell it; a 'property rule' forces a sale at a court-determined price.",answer:1,explanation:"False. The framework is reversed: a property rule lets the holder choose whether to sell (option to sell), while a liability rule forces a sale at a court-determined price (forced sale)."},
  {id:65,category:"Fair Housing",type:"multiple_choice",question:"In Shelley v. Kraemer (1948), the Court held that judicial enforcement of a racially restrictive covenant constituted state action because:",options:["When a state court enforces a private discriminatory agreement, the court itself is an actor satisfying the Fourteenth Amendment's 'state action' requirement", "Restrictive covenants are public regulatory devices analogous to zoning ordinances", "The Civil Rights Act of 1866 categorically converted private discrimination into state action", "Real estate is a public good that cannot be restricted by private contract"],answer:0,explanation:"Shelley reasoned that judicial enforcement was the but-for cause of the discrimination — and judicial action satisfies the 'no state shall' language. The doctrine has been criticized as potentially limitless, since virtually any private discrimination relies on courts to enforce property rights."},
  {id:66,category:"Fair Housing",type:"multiple_choice",question:"The Fair Housing Act's so-called 'Mrs. Murphy' exception permits discrimination in:",options:["Any single-family home sold without the use of a real estate broker", "Owner-occupied dwellings of four or fewer units, where the owner lives in one of the units", "Religious organizations selling property exclusively to members of their faith", "Public housing developments serving veterans"],answer:1,explanation:"The Mrs. Murphy exception (3603(b)(2)) covers small owner-occupied multi-unit dwellings where the owner lives on premises with no more than three other families. Note that the FHA's advertising prohibition applies even to Mrs. Murphy properties."},
  {id:67,category:"Fair Housing",type:"multiple_choice",question:"In Fair Housing Council v. Roommates.com (2012), the court held that the Fair Housing Act:",options:["Prohibits any online platform from publishing user-supplied housing preferences based on protected characteristics", "Categorically preempts the Communications Decency Act's immunity provisions for online publishers", "Permits roommate discrimination only when the housing unit has fewer than two bedrooms", "Does not apply to the selection of roommates because the FHA's 'dwelling' provisions do not reach intimate living relationships"],answer:3,explanation:"Roommates.com narrowly construed 'dwelling' to exclude intimate living arrangements like roommate selection. Congress did not intend the FHA to interfere with personal relationships inside the home, even though the platform itself could lose CDA immunity for facilitating discriminatory matching."},
  {id:68,category:"Fair Housing",type:"true_false",question:"Under the Fair Housing Act, a plaintiff alleging disparate impact bears the burden of proving the challenged practice caused a discriminatory effect; the burden then shifts to the defendant to prove a substantial, legitimate, nondiscriminatory interest.",answer:0,explanation:"True. The FHA recognizes disparate-impact claims with a burden-shifting framework. After defendant articulates a legitimate interest, plaintiff may still prevail by showing a less discriminatory alternative could serve the same interest."},
  {id:69,category:"Transfers",type:"multiple_choice",question:"In Pocono Springs v. MacKenzie (1995), the court held that real fee simple property:",options:["May be abandoned by surrendering possession and paying a release fee to the recording office", "May be abandoned only with the consent of all neighboring property owners", "Cannot be abandoned — once you hold fee simple title, you keep it (and its tax obligations) until you transfer it", "May be abandoned only after 21 years of nonuse, mirroring the adverse possession period"],answer:2,explanation:"Pocono Springs establishes that real property held in fee simple cannot be abandoned. The owner remains liable for taxes, HOA dues, and other burdens until they affirmatively transfer the property — even if it has no market value."},
  {id:70,category:"Transfers",type:"multiple_choice",question:"In Eyerman v. Mercantile Trust Co. (1975), the court held that a testator's instruction to destroy her house was:",options:["Enforceable absolutely as a sacred component of testamentary freedom", "Unenforceable only if the property had been formally designated a historic landmark", "Enforceable so long as the estate had sufficient assets to satisfy creditors", "Unenforceable as against public policy because destruction would harm the estate, neighboring property values, and the city without benefit to anyone"],answer:3,explanation:"Eyerman held that a court may void testamentary instructions that violate public policy. The right to dispose of property by will is a state-created right, not a natural right, and may be limited where destruction would harm beneficiaries and the broader community without offsetting benefit."},
  {id:71,category:"Transfers",type:"multiple_choice",question:"A valid gift causa mortis requires:",options:["A written instrument witnessed by two disinterested adults at the donor's bedside", "Delivery during the donor's lifetime, made in expectation of death from a specific cause, with the donor actually dying from that cause", "The donee accept the gift in writing before the donor's death", "Recording with the probate court before becoming effective against creditors"],answer:1,explanation:"Foster v. Reiss illustrates the strict elements: (1) delivery during lifetime, (2) made in expectation of imminent death from a specific cause, (3) donor must die from that cause. The gift fails if the donor recovers or dies of an unrelated cause."},
  {id:72,category:"Transfers",type:"true_false",question:"Under the nemo dat principle, a thief acquires only voidable title; a good-faith purchaser for value can acquire good title from the thief.",answer:1,explanation:"False. Theft creates void title — nothing can pass, even to a good-faith purchaser. Only fraud creates voidable title, which a GFPV can cure. This is the core distinction in Elicofon and Kotis."},
  {id:73,category:"Recording Systems",type:"multiple_choice",question:"Under a pure 'notice' recording statute, a subsequent purchaser prevails over a prior unrecorded interest if:",options:["The subsequent purchaser is a good-faith purchaser for value who lacks actual or constructive notice of the prior interest at the time of purchase", "The subsequent purchaser records first, regardless of notice", "The subsequent purchaser is a good-faith purchaser for value AND records before the prior interest is recorded", "The subsequent purchaser inspects the chain of title before purchase"],answer:0,explanation:"Pure notice statutes look only to notice at the time of acquisition, not to who records first. A subsequent GFPV without notice prevails even if they never record. Race-notice (option C) requires both no-notice AND first-to-record."},
  {id:74,category:"Recording Systems",type:"multiple_choice",question:"A pure 'race-notice' jurisdiction protects a subsequent purchaser only if:",options:["The subsequent purchaser pays full market value for the property", "The original transferor had recorded a deed first establishing chain of title", "The subsequent purchaser is a good-faith purchaser for value without notice AND records first", "The subsequent purchaser obtains a certificate of title from a state Torrens registrar"],answer:2,explanation:"Race-notice combines both protections: the subsequent purchaser must be a GFPV without notice AND must win the race to record. If neither party qualifies under race-notice, the jurisdiction defaults to nemo dat (first in time)."},
  {id:75,category:"Concurrent Ownership",type:"multiple_choice",question:"At common law, creation of a joint tenancy traditionally required the four unities of TTIP, which stands for:",options:["Title, Tenancy, Interest, and Possession", "Time, Title, Interest, and Possession", "Tenancy, Trust, Inheritance, and Privity", "Title, Trust, Interest, and Privity"],answer:1,explanation:"TTIP: Time (acquired together), Title (same instrument), Interest (equal shares), and Possession (equal right to whole). Many modern jurisdictions look to grantor's intent rather than strict TTIP, but the unities remain the historical baseline."},
  {id:76,category:"Concurrent Ownership",type:"multiple_choice",question:"A tenancy by the entirety differs from a joint tenancy primarily in that:",options:["It can be created among any number of co-owners, not just two", "It does not include a right of survivorship", "Either spouse may unilaterally sever and convey their interest", "It requires marriage between the co-tenants and prohibits unilateral conveyance — termination generally requires divorce or mutual action"],answer:3,explanation:"Tenancy by entirety is TTIP plus marriage. Unlike a joint tenancy, neither spouse can sever unilaterally — termination requires divorce, mutual conveyance through a strawperson, or death. This protects against unilateral creditor attachment in some jurisdictions."},
  {id:77,category:"Concurrent Ownership",type:"multiple_choice",question:"In Delfino v. Vealencis (1980), the court favored partition in kind over partition by sale because:",options:["Physical partition was practicable and equitable, and Vealencis's interests as a long-time resident operating a business on the land would be impaired by a forced sale", "Connecticut law categorically prohibits partition by sale unless all co-tenants consent", "The land's commercial value was indeterminate, making sale inappropriate", "One co-tenant had committed an 'ouster' that disqualified them from a sale remedy"],answer:0,explanation:"Delfino articulated a preference for partition in kind, granting partition by sale only when (1) physical attributes make division impractical or inequitable AND (2) the parties' interests are better served by sale. Modern courts more readily order partition by sale, but Delfino remains influential."},
  {id:78,category:"Landlord-Tenant",type:"true_false",question:"At common law under Paradine v. Jane, a tenant's duty to pay rent was an independent covenant that survived even when the tenant was forcibly dispossessed by an invading army for several years.",answer:0,explanation:"True. Paradine v. Jane (1647) is the classic 'independent covenants' case — frustration of purpose (here, three years of expulsion by Prince Rupert's army) was no defense to rent. Modern leases have moved sharply toward a contractual model, but Paradine retains symbolic force."},
  {id:79,category:"Landlord-Tenant",type:"multiple_choice",question:"The modern implied warranty of habitability for residential leases:",options:["Applies only to commercial tenancies in jurisdictions that have abandoned caveat lessee", "Permits landlords to disclaim it through a clear, conspicuous lease provision in most jurisdictions", "Often cannot be waived and is typically based on local housing codes", "Requires tenants to vacate the premises before suing for damages"],answer:2,explanation:"The implied warranty of habitability emerged in the 1960s-70s as a shift from caveat lessee. It typically (1) cannot be waived, (2) tracks local housing codes, and (3) does not require vacating — distinguishing it from the older constructive eviction doctrine still used in commercial leases."},
  {id:80,category:"Bailments & Licenses",type:"multiple_choice",question:"Under the doctrine of Wood v. Leadbitter (1845), a license to enter land:",options:["Becomes irrevocable once consideration is paid, regardless of whether it accompanies a grant", "Is revocable, unless it accompanies a valid grant", "Is a transferable property interest enforceable against successors in title", "Is functionally equivalent to an easement appurtenant"],answer:1,explanation:"Wood v. Leadbitter is the foundational rule: licenses are revocable. The single recognized exception is when the license accompanies a valid grant (e.g., a license to remove timber that has already been validly conveyed). Modern equity has added estoppel exceptions (see Holbrook)."},
  {id:81,category:"Bailments & Licenses",type:"multiple_choice",question:"In Allen v. Hyatt (1984), the parking arrangement constituted a bailment for hire because:",options:["The garage assumed possession, control, and custody — it limited access, required payment to exit, and the customer reasonably expected the car would be safeguarded", "The customer paid more than $500 for parking, satisfying UCC bailment requirements", "The garage attendant signed a written acceptance of the vehicle", "The garage was a public accommodation under Title II of the Civil Rights Act"],answer:0,explanation:"Allen v. Hyatt found bailment by implication based on the totality of circumstances: control over access, required payment to exit, and reasonable expectations of safeguarding. Compare with Rhodes (unattended lot — no bailment) and Dispeker (handing over keys — bailment)."},
  {id:82,category:"Bailments & Licenses",type:"multiple_choice",question:"Under the majority rule in Cowen v. Pressprich (1922), an involuntary bailee:",options:["Owes the same duty of care as a bailee for hire because possession is determinative", "Is liable only for gross negligence regardless of any subsequent action", "Has no duty to the owner unless the involuntary bailee 'exercises dominion' over the property — at which point it assumes voluntary-bailee duties", "Has an absolute duty to deliver the property, identical to a common carrier"],answer:2,explanation:"The majority in Cowen drew a sharp line: no duty unless dominion is exercised. The dissent would have imposed a 'reasonable courtesy and care' duty even on involuntary bailees, emphasizing connectedness rather than dominion."},
  {id:83,category:"Mortgages",type:"true_false",question:"At common law, the equity of redemption permits a borrower to recover the property by paying the debt even after the secured creditor has commenced foreclosure proceedings.",answer:0,explanation:"True. The equity of redemption allows the borrower to redeem before foreclosure sale (and in some jurisdictions, post-sale via a statutory right of redemption). It is a core protection alongside the right of sale and the lender's fiduciary duty of due diligence."},
  {id:84,category:"Mortgages",type:"multiple_choice",question:"In US Bank v. Ibanez (2011), the Massachusetts Supreme Judicial Court invalidated foreclosures because:",options:["The borrowers had cured their default before the sale by tendering the missed payments", "The foreclosing banks could not prove they held valid, completed assignments of the mortgages at the time the foreclosure sales were initiated", "Massachusetts is a lien-theory state requiring judicial foreclosure for all defaults", "The mortgages had been securitized in violation of state recording statutes"],answer:1,explanation:"Ibanez applied basic nemo dat to mortgage assignments: you cannot foreclose on what you do not own. Assignments require a signed writing identifying the assignee — assignments 'in blank' or with backdated effective dates are insufficient. The case exposed widespread foreclosure-paperwork failures after 2008."},
  {id:85,category:"Easements",type:"multiple_choice",question:"At common law, the four traditional categories of negative easements (WALS) protect rights to:",options:["Wells, Alleys, Lots, and Streams", "Walls, Annexes, Lights, and Sheds", "Wells, Air, Land, and Sewerage", "Water, Air, Light, and Support"],answer:3,explanation:"WALS = Water, Air, Light, and Support. These are the only traditional negative easements: rights to stop a neighbor from diverting water, blocking air channels, blocking light, or undermining structural support. Most easements are affirmative (allowing the holder to do something on servient land)."},
  {id:86,category:"Easements",type:"multiple_choice",question:"In Holbrook v. Taylor (1976), an oral license to use a road became an irrevocable easement by estoppel because:",options:["The licensees relied on the permission to make substantial improvements (building an expensive structure accessible only via the road), so revocation would cause unjust enrichment", "The license had been used continuously and adversely for the statutory adverse possession period", "The road appeared on a recorded subdivision plat, giving constructive notice to all subsequent owners", "The licensees had paid consideration for the right to use the road over a 20-year period"],answer:0,explanation:"Holbrook is the classic estoppel easement: detrimental reliance on the licensor's permission, combined with substantial improvements, transforms a revocable license into an irrevocable easement. This avoids the unjust enrichment that would result if the licensor could revoke after the licensee invested."},
  {id:87,category:"Covenants",type:"true_false",question:"Tulk v. Moxhay (1848) established that a restrictive covenant binds a subsequent purchaser who takes the land with notice of the restriction, even absent strict legal privity.",answer:0,explanation:"True. Tulk created the equitable servitude — enforceable in equity against any successor with notice. This was a key innovation: the common law required strict privity for covenants to run, but equity would enforce based on notice alone, transforming the law of covenants."},
  {id:88,category:"Zoning",type:"multiple_choice",question:"In Village of Euclid v. Ambler Realty (1926), the Supreme Court upheld comprehensive municipal zoning as:",options:["An exercise of federal Commerce Clause authority delegated to municipalities", "A taking compensable under the Fifth Amendment but constitutionally permissible", "A valid exercise of police power, analogous to nuisance regulation, justified by public health, safety, and welfare", "An exercise of the Fourteenth Amendment Section 5 enforcement power"],answer:2,explanation:"Euclid analogized zoning to nuisance regulation and upheld it under the police power. The Court explicitly declined to strike down the entire ordinance, instead leaving room for as-applied challenges to specific provisions where the public interest does not justify the burden."},
  {id:89,category:"Zoning",type:"multiple_choice",question:"NAACP v. Mount Laurel (1975) held that a New Jersey municipality's exclusionary zoning:",options:["Was permissible because zoning is a quintessentially local matter beyond constitutional review", "Violated the federal Fair Housing Act's disparate-impact provisions", "Was permissible so long as the municipality could show some legitimate fiscal justification", "Must affirmatively provide opportunity for variety and choice of housing — municipalities derive their power from the state and must consider statewide welfare, not just their own"],answer:3,explanation:"Mt. Laurel imposed an affirmative obligation: developing municipalities must zone to permit a 'fair share' of regional housing needs. The decision used effects-based review (not intent) and applied a burden-shifting framework — fiscal justifications alone are insufficient."},
  {id:90,category:"Takings",type:"multiple_choice",question:"In Kelo v. New London (2005), the Supreme Court held that:",options:["Economic-development takings can satisfy the 'public use' requirement when part of a comprehensive development plan, with deferential review of legislative determinations", "Public use requires actual physical use by the general public, such as roads or parks", "Takings to transfer property to private developers are categorically barred regardless of the redevelopment plan", "Public use is satisfied only by takings that eliminate documented blight"],answer:0,explanation:"Kelo extended Berman and Midkiff: a comprehensive development plan satisfies public use under deferential rational-basis review. Justice Kennedy's controlling concurrence applied 'RBR with bite' to look for pretext. Justice Thomas's dissent would have required actual public use; many states responded with statutes barring economic-development takings."},
  {id:91,category:"Takings",type:"multiple_choice",question:"Justice Holmes's famous formulation in Pennsylvania Coal v. Mahon (1922) is that:",options:["A regulation is a taking only if it physically dispossesses the owner from the land", "Any regulation reducing property value by more than 50% constitutes a per se taking", "While property may be regulated to some extent, if regulation 'goes too far' it will be recognized as a taking", "All economic regulations affecting property are governed by rational basis review and compensation is unavailable"],answer:2,explanation:"Mahon birthed regulatory takings doctrine. Holmes considered three factors: extent of diminution, public purpose (vs. pure nuisance prevention), and reciprocity of advantage. Brandeis's dissent — focusing on the parcel as a whole and the public-purpose justification — anticipated modern doctrine."},
  {id:92,category:"Takings",type:"multiple_choice",question:"Under Penn Central Transportation Co. v. New York City (1978), the Court analyzes regulatory takings using factors including:",options:["Whether the regulation is content-neutral and serves a compelling government interest", "Whether the regulation imposes a physical occupation, regardless of its economic impact", "The exclusive question of whether the regulation eliminates 100% of the economic use of the property", "The economic impact of the regulation, the extent to which it interferes with reasonable investment-backed expectations, and the character of the government action"],answer:3,explanation:"The Penn Central three-factor test — economic impact, investment-backed expectations, and character of government action — is the default framework for non-categorical regulatory takings. The Court refused to view 'air rights' as a separate parcel, instead analyzing the property as a whole."},
  {id:93,category:"Takings",type:"true_false",question:"Under US v. Miller (1943), if land is within the original scope of a public project, just compensation is calculated based on the land's value before the government committed to the project — without crediting any increase in value caused by the project itself.",answer:0,explanation:"True. Miller prevents owners from capturing speculative gains attributable to the project. If, however, the land was not initially within the project's scope and was added later, owners may capture the appreciation up until the date the property was included."},
  {id:94,category:"Takings",type:"multiple_choice",question:"Lucas v. South Carolina Coastal Council (1992) held that a regulation effecting a total wipeout of economic value:",options:["Is presumptively constitutional under the Penn Central factors so long as it serves a public purpose", "Is a per se taking unless the proscribed use was already barred by background principles of state property or nuisance law", "Requires compensation only if the affected parcel is residential rather than commercial", "Must be analyzed as a regulatory taking under rational basis review"],answer:1,explanation:"Lucas created a categorical rule for total economic wipeouts, supplementing Loretto's per se rule for permanent physical occupations. The narrow exception — 'background principles' of state property law — allows uncompensated regulation of activities that were already prohibited (e.g., common-law nuisances)."}
    ]
  }
};
...
const categoryColors = {
  ...
  "Transfers": "#9333EA", "Takings": "#9F1239"
};
